...
<div class="container">
   ...
   <label for="exampleInputEmail1">Tên kích thước * :</label>
    <f:input type="text" class="form-control"  id="exampleInputEmail1" placeholder="Nhập tên kích thước " name="ten" path="ten"/>
       <f:errors style="color:red" path="ten" element="div"></f:errors>
      <br>
      <button type="submit" class="btn btn-danger"><i class="fa-solid fa-plus"></i> Thêm kích thước</button>
