...
<c:if test="${not empty message}">
 ...
 <h1 class="giua"> Quản Lý Đơn Hàng</h1>
      <br>
      <table class="table">
      <tr>
      <td>ID Hóa Đơn</td>
      ...
      <td>${p.idHoaDon }</td>
       ...
       <td>
     	 ...
     	 <button class="btn btn-info"><a style="color: white; text-decoration: none;"  href="${pageContext.request.contextPath }/manage-order/chitiet/${p.idHoaDon }" >Chi Tiết</a></button>
     	</c:if>
     	 <c:if test="${p.trangThai == 0 }">
     	  <button class="btn btn-info"><a style="color: white; text-decoration: none;"  href="${pageContext.request.contextPath }/manage-order/chitiet/${p.idHoaDon }" >Chi Tiết</a></button>
     	 <button class="btn btn-danger"><a style="color: white; text-decoration: none;" href="${pageContext.request.contextPath }/manage-order/huy/${p.idHoaDon }">Hủy</a></button>
     	 <button class="btn btn-success"><a style="color: white; text-decoration: none;" href="${pageContext.request.contextPath }/manage-order/thanhtoan/${p.idHoaDon }">Đã giao hàng</a></button>
     	 </c:if>
