...
<div class="container">
    ...
    <f:form action="${pageContext.request.contextPath}/category/update" method="post" modelAttribute="data">
 	 <f:input type="hidden" class="form-control"  id="exampleInputEmail1" placeholder="Nhập tên " name="ten" value="${cate.id }" path="id"/>
                  <label for="exampleInputEmail1">Tên Catefory * :</label>
    <f:input type="text" class="form-control"  id="exampleInputEmail1" placeholder="Nhập tên " name="ten" value="${cate.ten }" path="ten"/>
