                        ...
                        <input type="hidden" id="type" value="${type }">
                          ...
                          <f:form action="login" method="post" modelAttribute="data" enctype="multipart/form-data">
                            ...
                            <div class="d-flex align-items-center mb-3 pb-1">
                              <span class="h1 fw-bold mb-0"> <h1 class="giua"><i class="fa-solid fa-right-to-bracket"></i> Đăng Nhập</h1></span>
                            </div>
          
                            <h6 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Đăng nhập với tài khoản của bạn</h6>
                            ...
                            <a class="small text-muted" href="forget">Quên mật khẩu</a>
